        ...
        <form
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="categories[]" id="categories" multiple>
                    <option value="" disabled selected>Please, Select Product Categories</option>
            ...
            <div class="mb-3">
                ...
                <textarea name="moreDescription" class="form-control" id="moreDescription"
                    aria-describedby="moreDescriptionHelp">{{ old('moreDescription', isset($product) ? $product->moreDescription : '') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input type="text" placeholder="AdditionnalInfos ..." name="additionnalInfos"
                    value="{{ old('additionnalInfos', isset($product) ? $product->additionnalInfos : '') }}"
                    class="form-control" id="additionnalInfos" aria-describedby="additionnalInfosHelp" required />
            ...
            <div class="mb-3">
                ...
                <input type="text" placeholder="Stock ..." name="stock"
                    value="{{ old('stock', isset($product) ? $product->stock : '') }}" class="form-control" id="stock"
            ...
            <div class="mb-3">
                ...
                <input type="text" placeholder="Brand ..." name="brand"
                    value="{{ old('brand', isset($product) ? $product->brand : '') }}" class="form-control" id="brand"
                    aria-describedby="brandHelp" required />
            ...
            <div class="mb-3 d-flex gap-2">
                ...
                <div class="form-check form-switch">
                    <input name="isBestSeller" id="isBestSeller" value="true" data-bs-toggle="toggle" {{ old('isBestSeller', isset($product) && $product->isBestSeller == 'true' ? 'checked' : '') }}
                        class="form-check-input" type="checkbox" role="switch" />
                </div>
                {{-- <select class="form-control" name="isBestSeller" id="isBestSeller">
                    <option value="true" {{ old('isBestSeller', isset($product) && $product->isBestSeller == 'true' ?
                        'selected' : '') }}>Yes</option>
                    <option value="false" {{ old('isBestSeller', isset($product) && $product->isBestSeller == 'false' ?
                        'selected' : '') }}>No</option>
                </select> --}}
            ...
            <div class="mb-3 d-flex gap-2">
                ...
                <div class="form-check form-switch">
                    <input name="isNewArrival" id="isNewArrival" value="true" data-bs-toggle="toggle" {{ old('isNewArrival', isset($product) && $product->isNewArrival == 'true' ? 'checked' : '') }}
                        class="form-check-input" type="checkbox" role="switch" />
                </div>
                {{-- <select class="form-control" name="isNewArrival" id="isNewArrival">
                    <option value="true" {{ old('isNewArrival', isset($product) && $product->isNewArrival == 'true' ?
                        'selected' : '') }}>Yes</option>
                    <option value="false" {{ old('isNewArrival', isset($product) && $product->isNewArrival == 'false' ?
                        'selected' : '') }}>No</option>
                </select> --}}
            ...
            <div class="mb-3 d-flex gap-2">
                ...
                <div class="form-check form-switch">
                    <input name="isFeatured" id="isFeatured" value="true" data-bs-toggle="toggle" {{ old('isFeatured', isset($product) && $product->isFeatured == 'true' ? 'checked' : '') }} class="form-check-input"
                        type="checkbox" role="switch" />
                </div>
                {{-- <select class="form-control" name="isFeatured" id="isFeatured">
                    <option value="true" {{ old('isFeatured', isset($product) && $product->isFeatured == 'true' ?
                        'selected' : '') }}>Yes</option>
                    <option value="false" {{ old('isFeatured', isset($product) && $product->isFeatured == 'false' ?
                        'selected' : '') }}>No</option>
                </select> --}}
            ...
            <div class="mb-3 d-flex gap-2">
                ...
                <div class="form-check form-switch">
                    <input name="isSpecialOffer" id="isSpecialOffer" value="true" data-bs-toggle="toggle" {{ old('isSpecialOffer', isset($product) && $product->isSpecialOffer == 'true' ? 'checked' : '') }}
                        class="form-check-input" type="checkbox" role="switch" />
                </div>
                {{-- <select class="form-control" name="isSpecialOffer" id="isSpecialOffer">
                    <option value="true" {{ old('isSpecialOffer', isset($product) && $product->isSpecialOffer == 'true'
                        ? 'selected' : '') }}>Yes</option>
                    <option value="false" {{ old('isSpecialOffer', isset($product) && $product->isSpecialOffer ==
