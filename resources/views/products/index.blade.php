                                            ...
                                            <tr>
                                                                                        ...
                                                                                        @if (!empty($images) && is_array($images))
                                                                                            @foreach ($images as $url)
                                                                                                <img src="{{ Str::startsWith($url, 'http') ? $url : Storage::url($url) }}"
                                                                                                    alt="Prévisualisation de l'image" class="img-thumbnail"
                                                ...
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input name="isAvaible" id="isAvaible" data-id="{{$product->id}}" value="true"
                                                            data-bs-toggle="toggle" {{ isset($product) && $product->isAvaible == 'true' ? 'checked' : '' }} class="form-check-input" type="checkbox" role="switch" />
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-switch">
