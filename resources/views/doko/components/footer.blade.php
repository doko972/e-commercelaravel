            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 col-sm-6">
                    <div class="widget">
                        ...
                        <ul class="widget_links">
                            <li><a routerlink="account" ng-reflect-router-link="account" href="/account">My Account</a>
                            </li>
                            <li><a routerlink="terms" ng-reflect-router-link="terms" href="/terms">Terms</a></li>
                            <li><a routerlink="signin" ng-reflect-router-link="signin" href="/signin">SignIn</a></li>
                            <li><a routerlink="signup" ng-reflect-router-link="signup" href="/signup">Signup</a></li>
                        </ul>
                    </div>
                </div>
