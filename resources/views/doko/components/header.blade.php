                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        ...
                        <ul class="contact_detail text-center text-lg-start">
                            <li><i class="ti-mobile"></i><span>+33 7 49 31 69 74</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="text-center text-md-end">
                        <ul class="header_list">
                            <li><a routerlink="/compare" ng-reflect-router-link="/compare" href="/compare"><i
                                        class="ti-control-shuffle"></i><span>Compare</span></a></li>
                            <li><a routerlink="/wishlist" ng-reflect-router-link="/wishlist" href="/wishlist"><i
                                        class="ti-heart"></i><span>Wishlist</span></a></li>
                            <li><a routerlink="/signin" ng-reflect-router-link="/signin" href="/signin"><i
                                        class="ti-user"></i><span>Signin</span></a>
                            </li>
                            <li><a routerlink="/signup" ng-reflect-router-link="/signup" href="/signup"><i
                                    ...
                                    <li class="mega-menu-col col-lg-3">
                                        <ul>
                                            ...
                                            <li><a class="dropdown-item nav-link nav_item"
                                                    ...
                                                    côtelé</a><a class="dropdown-item nav-link nav_item"
                                    ...
                                    <li class="mega-menu-col col-lg-3">
                                        <ul>
                                            ...
                                            <li><a class="dropdown-item nav-link nav_item"
                                                    ...
                                                    haute</a><a class="dropdown-item nav-link nav_item"
                                                    ng-reflect-router-link="/,product,jupe-imprim-floral-t"
                                                    href="/product/jupe-imprim-floral-taille-fronce">Jupe à imprimé
                                    ...
                                    <li class="mega-menu-col col-lg-3">
                                        <ul>
                                            ...
                                            <li><a class="dropdown-item nav-link nav_item"
                                                    ...
                                                    froncée à poches</a><a class="dropdown-item nav-link nav_item"
                        ...
                        <div class="cart_box dropdown-menu dropdown-menu-right">
                            ...
                            <div class="cart_footer">
                                ...
                                <p class="cart_buttons"><a routerlink="/cart" class="btn btn-fill-line view-cart"
                                        ...
                                        ng-reflect-router-link="/checkout" href="/checkout">Checkout</a></p>
                            </div>
                        </div>
                    </li>
                </ul>
