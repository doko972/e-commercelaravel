...
<div class="row">
   ...
   <d       iv class="mb-3">
                ...
                <input type="text" placeholder="Name ..." name="name"
                    value="{{ old('name', isset($category) ? $category->name : '') }}" class="form-control" id="name"
            ...
            <div class="mb-3 d-flex gap-2">
                ...
                <div class="form-check form-switch">
                    ...
                    <input name="isMega" id="isMega" value="1" data-bs-toggle="toggle" {{ old('isMega', isset($category) && $category->isMega ? 'checked' : '') }} class="form-check-input" type="checkbox"
                        role="switch" />
                </div>
                {{-- <select class="form-control" name="isMega" id="isMega">
                    <option value="true" {{ old('isMega', isset($category) && $category->isMega == 'true' ? 'selected' :
                        '') }}>Yes</option>
                    <option value="false" {{ old('isMega', isset($category) && $category->isMega == 'false' ? 'selected'
                        : '') }}>No</option>
                </select> --}}
